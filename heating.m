...
TE = 315.66; %  Ambient temperature in Kelvin
tau = (m*cp)/(4*eps*sigma*A_s*TE^3); % heating constant
%tau = 3.95e4;
...
tspan = [0 3660]; % Time interval from 0 to 3660 seconds

% Initial condition
T0 = 293; % Initial temperature in Kelvin
